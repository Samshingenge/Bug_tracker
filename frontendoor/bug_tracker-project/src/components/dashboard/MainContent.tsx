...
//           </CardContent>
//         </Card>
//         <Button v  className="bg-gray-800 text-white">Customize</Button>
//       </div>
...
// import { CheckCircle, Users } from 'lucide-react';
// import Avatar from 'react-avatar';
// import { Label } from "@/components/ui/label";  // Ensure Label component is properly imported
...
//           </CardContent>
//         </Card>
//         <Button variant="default" className="bg-gray-800 text-white">Customize</Button>
//       </div>
